...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-5 left-5 right-5 z-50 pointer-events-none">
      <GlassPanel
        weight="chrome"
        className="pointer-events-auto rounded-full py-2 px-3 flex justify-around items-center"
      >
        {navItems.map((item) => {
